    ...
    \resumeSubheading
      ...
      \begin{itemize}[leftmargin=0.15in, label={}]
        \small{\item{
         \textbf{Coursework}{: } \\
         \resumeItemListStart
          \resumeItem{Introduction to Secure Coding}
          \resumeItem{Penetration Testing}
          \resumeItem{Hacking of C Programs and Unix Binaries}
          \resumeItem{Secure Operating Systems}
          \resumeItem{Security Tools for Information Security}
