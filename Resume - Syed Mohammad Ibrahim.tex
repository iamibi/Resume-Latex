...
\begin{center}
    ...
    \small +1(240)615-3974 $|$ \href{mailto:iamibi@umd.edu}{iamibi@umd.edu} \\ \vspace{2pt}
...
\resumeSubHeadingListStart
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      ...
      \resumeItem{Exploitation techniques involved, but not limited to, Cross-Site Scripting (XSS), SQL Injection, Vulnerable Wordpress Plugin, MS17\_010 Eternal Blue, Cowroot, etc.}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Network \& Pentesting Tools}{: Hashcat, Burp Suite, AFL, NMap, Hydra, Dig, Searchsploit, Wpscan, Metasploit, Wireshark }
    }}
 \end{itemize}
