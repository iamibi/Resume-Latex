...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {\href{https://www.nvidia.com/}{NVIDIA Corporation}}{Adelphi, USA}
      {Information Security Analyst Intern}{May 2022 -- Aug. 2022}
    \resumeItemListStart
      \resumeItem{Implemented Security Control Automation Framework}
      \resumeItem{Developed a process for code development and quality assurance}
      \resumeItem{Assisted with Compliance Monitoring and Reporting}
    \resumeItemListEnd
...
\resumeSubHeadingListStart
  \resumeProjectHeading
    {\textbf{Avionics Dash Server} $|$ \emph{Python, Flask, MongoDb}}{\href{https://github.com/iamibi/avionics-dash-server}{\includegraphics[scale=0.10]{github.png}}}
    \resumeItemListStart
      \resumeItem{Developed the backend for Avionics Dash using Flask REST Api's}
      \resumeItem{Deployed the application on https://app.koyeb.com for client access}
      \resumeItem{Implemented security features like password hashing, session based authentication using JWT, and more}
      \resumeItem{Configured CI/CD pipelines for robust development and response}
    \resumeItemListEnd
  \resumeProjectHeading
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {University of Maryland, A. James Clark School of Engineering}{Aug. 2021 -- Dec. 2022}
