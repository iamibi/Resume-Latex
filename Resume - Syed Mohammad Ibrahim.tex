...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Master of Engineering in Cybersecurity}{College Park, USA}
...
\resumeSubHeadingListStart
  \resumeProjectHeading
    ...
    \resumeItemListStart
      \resumeItem{A project that focuses on Security and implements the concepts of secure coding}
      \resumeItem{Implemented logging, password hashing and salting, AntiXss Sanitization and Sessions as part of the project}
      \resumeItem{This project is part of Introduction to Secure Coding course}
    \resumeItemListEnd
  \resumeProjectHeading
