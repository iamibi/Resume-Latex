...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart
        \resumeItem{Responsible for handling backend infrastructure services.}
        \resumeItem{Worked on milestone based feature development and enhancements.}
        \resumeItem{Responsible for improvements in Unit Testing framework.}
    \resumeItemListEnd
    \begin{tabular*}{0.97\textwidth}[t]{l@{\extracolsep{\fill}}r}
